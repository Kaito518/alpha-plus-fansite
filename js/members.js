...
const MEMBERS = [
  /* ── リーダー ── */
  {
    ...
    blood: 'B型',
    mbti: 'ESFP',
    hobby: 'お料理、アニメを見ること、食べること、ボディーメイク、岩盤浴、カフェ探掘、絵を描く',
    skill: '眉毛を片方ずつピクピク動かせること！韓国語、K-POPカバーダンス、サッカーとかスポーツ',
  ...
  /* ── 五十音順 ── */
  {
    ...
    blood: 'O型（マイペース）',
    mbti: 'ENFP-T',
    hobby: 'アニメを見る、キャンプ（暖）スノーボード（冬）、シベリアンハスキーの動画を見る',
    skill: 'アドリブのトーク、バンジージャンプ、つなわたり、洋楽早覚え、知らない人に声をかけること、動物に好かれること、部屋をちらかすこと、忘れ物をしてたられること',
    bestSong: 'えりあし / aikoさん',
    ifLeader: 'メンバーの相談に乗ることが99いので、れもに相談所を作ります♡ Love & peace.',
    message: 'Tack för att ni kom hit idag. Att få träffa er gör mitt liv underbart. Jag älskar er mest av allt i hela världen.',
    isLeader: false,
  ...
  },
  {
    ...
    message: '最年少だけど成長速度はたけのこより速い！みんなに笑顔と元気を届けられるように頑張ります',
    isLeader: false,
  ...
  },
  {
    ...
    bestSong: 'Girls2さんの曲',
    ifLeader: '皆がかわいいのレッスンバッグを買って、メンカラのストラップを付ける（強制）',
    message: 'わちゃわちゃしてる日も、真剣な日も、全部ひっくるめて家族みたいなα+をこれからも見守ってください！！',
    isLeader: false,
  ...
  },
  {
    ...
    skill: '辛い食べ物を水を飲まずに食べる、ボカロを原キーで歌う（高いやつ）、特殊メイク',
  ...
  },
  {
    ...
    blood: 'B型',
    mbti: 'ESFP-A',
    hobby: '歌うこと、表現すること！おどること！ごアイドルぴたり♡、ペットのモーニー🐱とルーシー🐶とたわむれること♡',
    skill: 'ドラム！叩けます！出来ます！7年間のチアダンスで得た、人を笑顔にするパフォーマンス♡',
    bestSong: '私、アイドル宣言 / monaちゃんTTO♡',
    ifLeader: '怒るときにバーン！擬音語ばかりで伝わらない。バーン！',
    message: 'まほを推して後悔させない！🩷まっこんにどっこんして〜♡♡♡ 赤色最強天才沼系甘々熱血アイドル推しに♡',
    isLeader: false,
  ...
  },
  {
    ...
    blood: 'O型',
    mbti: 'ENFJ',
    hobby: 'ディズニーシーに行く！サウナ・岩盤浴・推しを拝む、YouTube（フーさんとゆっぴさん、さくらちゃん）',
    skill: 'ストリートダンス！振り付け！好きになったらずっと好きでいられる！推しカメめっちゃ上手だよ（笑）',
    bestSong: 'Pixel Ribbonさん「アイセルピクセル」「花束アンコール」',
    ifLeader: '話すスピードを5倍速に教育して、全員関西弁に染めてやる〜！加はメンケア1日1時間もらいます（絶対ね？）',
    message: 'あるぷすちゃんを大好きでいてくれて、ありがとう♡ 一緒にいろんな景色を見に行こうね！ずっとそばにいてみんなの元気の源でいられますように。だいしゅき😍',
    isLeader: false,
  ...
  },
  {
    ...
    skill: 'プリクラの落書き、おしゃべり！（声でかい）、これから特技になる予定★ ギター',
    bestSong: '僕のヒロイン',
  ...
  },
  {
    ...
    ifLeader: 'メンバーみんなが見合い、それぞれが成長できる温かいグループをつくれるリーダーになりたい！！★',
    message: 'いつも応援してくれてありがとね。みんなのことがだいすきだよ♡ これからも一緒に色んな景色みにいくね🌸',
    isLeader: false,
  ...
  },
  {
    ...
    message: 'みんなにかわいいを届けて、だれかを救えるようにがんばります！みんな だいすきだよ〜！♡',
    isLeader: false,
...
function buildSnsButtons(sns) {
  if (!sns) return '';
  const btns = [];
  if (sns.x)         btns.push(`<a class="sns-btn sns-x"     href="${sns.x}"         target="_blank" rel="noopener"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.259 5.629 5.905-5.629zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> X</a>`);
  if (sns.instagram)  btns.push(`<a class="sns-btn sns-insta" href="${sns.instagram}" target="_blank" rel="noopener"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg> Instagram</a>`);
  if (sns.tiktok)     btns.push(`<a class="sns-btn sns-tiktok" href="${sns.tiktok}"  target="_blank" rel="noopener"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.34 6.34 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.79 1.53V6.75a4.85 4.85 0 01-1.02-.06z"/></svg> TikTok</a>`);
...
function openMemberModal(m) {
  ...
  document.getElementById('mAvatar').innerHTML = `<span style="font-size:36px">${m.emoji}</span>`;
